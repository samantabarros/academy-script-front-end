          ...
          <div class="q-mb-md q-px-md">
            ...
            <q-form @submit="onSubmit" ref="myForm">
              ...
              <div class="q-mb-md flex flex-center">
                <router-link class="text-white text-subtitle1 text-weight-regular" to="/">
                  Esqueceu a senha?
                </router-link>
              </div>
            </q-form>
...
/* Rules */
const usuarioRules = [
  (val) => (val && val.length > 0) || 'Você precisa preencher os campos em vermelho'
];

const senhaRules = [
  (val) => (val && val !== null && val !== '') || 'Você precisa preencher os campos em vermelho',
